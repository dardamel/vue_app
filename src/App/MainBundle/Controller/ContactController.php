...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppMainBundle:Contact')->findAll();

        return $this->render('AppMainBundle:Contact:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppMainBundle:Contact:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppMainBundle:Contact')->find($id);
        ...
        return $this->render('AppMainBundle:Contact:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppMainBundle:Contact:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new ContactType(), $entity, array(
            'action' => $this->generateUrl('admin_contact_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
